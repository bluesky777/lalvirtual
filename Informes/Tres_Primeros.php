...
<div class="titulo1"><?php echo $NomGr; ?></div>
	<div class="InfoPuest">
		<div id="SegundoPuest">
			...
			<span class="PorcUsu"><? echo number_format($DatosPuest[1]["PromedioAlum"], 1);?></span>
		...
		<div id="PrimerPuest">
			...
			<span class="PorcUsu"><? echo number_format($DatosPuest[0]["PromedioAlum"], 1);?></span>
		...
		<div id="TercerPuest">
			...
			<span class="PorcUsu"><? echo number_format($DatosPuest[2]["PromedioAlum"], 1);?></span>
